package com.example.customer_front_thymleaf_app.security;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity.
                ...
                authorizeHttpRequests(ar->ar.requestMatchers("/","/oauth2Login","/h2-console/**","/webjars/**").permitAll()).
                authorizeHttpRequests(ar->ar.anyRequest().authenticated()).
                oauth2Login(al->al.loginPage("/oauth2Login").defaultSuccessUrl("/")).
                logout(out->out.logoutSuccessHandler(this.oidcLogoutSuccessHandler())
